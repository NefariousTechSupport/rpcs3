...
const std::map<const std::pair<const u16, const u16>, const std::string> list_skylanders = {
	...
	{{1, 0x1811}, "Series 2 Glow In The Dark Sonic Boom"},
    {{2, 0x0000}, "Warnado"},
	...
	{{14, 0x2805}, "Series 2 Metallic Green Gill Grunt"},
    ...
    {{307, 0x3000}, "Sunscraper Spire"},
    {{308, 0x3000}, "Midnight Museum"},
    ...
    {{541, 0x1000}, "Thumpling"},
    {{514, 0x0000}, "Gill Runt"},
    {{542, 0x1000}, "Mini-Jini"},
    {{503, 0x3000}, "Spry"},
    {{504, 0x3000}, "Hijinx"},
    {{543, 0x1000}, "Eye Small"},
    {{601, 0x5000}, "King Pen"},
	{{601, 0x5402}, "Dark King Pen"},
    {{602, 0x5000}, "Tri-Tip"},
	{{602, 0x5403}, "Legendary Tri-Tip"},
    {{603, 0x5000}, "Chopscotch"},
	{{603, 0x5411}, "Candy Coated Chopscotch"},
    {{604, 0x5000}, "Boom Bloom"},
    {{605, 0x5000}, "Pit Boss"},
	{{605, 0x5403}, "Legendary Pit Boss"},
    {{606, 0x5000}, "Barbella"},
    {{607, 0x5000}, "Air Strike"},
	{{607, 0x540D}, "Egg Bomber Air Strike"},
    {{608, 0x5000}, "Ember"},
    {{609, 0x5000}, "Ambush"},
    {{610, 0x5000}, "Dr. Krankcase"},
    {{611, 0x5000}, "Hood Sickle"},
	{{611, 0x5402}, "Steel Plated Hood Sickle"},
    {{612, 0x5000}, "Tae Kwon Crow"},
	{{612, 0x5402}, "Mystical Tae Kwon Crow"},
    {{613, 0x5000}, "Golden Queen"},
	{{613, 0x5402}, "Dark Golden Queen"},
    {{614, 0x5000}, "Wolfgang"},
	{{614, 0x5402}, "Dark Wolfgang"},
    {{615, 0x5000}, "Pain-Yatta"},
    {{616, 0x5000}, "Mysticat"},
    {{617, 0x5000}, "Starcast"},
    {{618, 0x5000}, "Buckshot"},
    {{619, 0x5000}, "Aurora"},
    {{629, 0x5402}, "Solar Flare Aurora"},
    {{620, 0x5000}, "Flare Wolf"},
	{{620, 0x540D}, "Hard Boiled Flare Wolf"},
    {{621, 0x5000}, "Chompy Mage"},
    {{621, 0x540E}, "Jingle Bell Chompy Mage"},
	{{622, 0x5000}, "Bad Juju"},
	{{622, 0x5402}, "Mystical Bad Juju"},
    ...
    {{3302, 0x2000}, "Fiery Forge"},
    {{3303, 0x2000}, "Arkeyan Crossbow"},
    ...
    //{{3233, 0x4000}, "Clown Cruiser (Nintendo Only)"},
    ...
    {{3413, 0x4100}, "Hurricane Jet Vac"},
    {{3413, 0x4503}, "Legendary Hurricane Jet Vac"},
    {{3414, 0x4100}, "Double Dare Trigger Happy"},
    {{3414, 0x4502}, "Power Blue Double Dare Trigger Happy"},
    {{3415, 0x4100}, "Super Shot Stealth Elf"},
    {{3415, 0x4502}, "Dark Super Shot Stealth Elf"},
    {{3416, 0x4100}, "Shark Shooter Terrafin"},
    {{3417, 0x4100}, "Bone Bash Roller Brawl"},
    {{3417, 0x4503}, "Legendary Bone Bash Roller Brawl"},
    {{3420, 0x4100}, "Big Bubble Pop Fizz"},
    {{3420, 0x450E}, "Birthday Bash Big Bubble Pop Fizz"},
    {{3421, 0x4100}, "Lava Lance Eruptor"},
    {{3422, 0x4100}, "Deep Dive Gill Grunt"},
    //{{3423, 0x4000}, "Turbo Charge Donkey Kong (Nintendo Only)"},
    //{{3423, 0x4502}, "Dark Turbo Charge Donkey Kong (Nintendo Only)"},
    //{{3424, 0x4000}, "Hammer Slam Bowser (Nintendo Only)"},
